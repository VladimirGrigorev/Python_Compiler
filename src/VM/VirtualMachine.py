...
from src.VM.Instructions import *
from src.VM.Context import Context
from src.Сompiler.code_generator import CodeLine
...
class VirtualMachine:
    ...
    def call_builtin(self, func_name):
        method_to_call = getattr(src.Сompiler.custom_builtins, func_name)
        args = []
